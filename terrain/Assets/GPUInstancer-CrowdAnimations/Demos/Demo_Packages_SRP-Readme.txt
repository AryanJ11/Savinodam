...
- If you are using Universal Render Pipeline, you can extract the package "Crowd_Animations-URP_Demos_Package" under the "GPUInstancer-CrowdAnimations/Demos/" folder.
- If you are using High Definition Render Pipeline, you can extract the package "Crowd_Animations-HDRP_Demos_Package" under the "GPUInstancer-CrowdAnimations/Demos/" folder.

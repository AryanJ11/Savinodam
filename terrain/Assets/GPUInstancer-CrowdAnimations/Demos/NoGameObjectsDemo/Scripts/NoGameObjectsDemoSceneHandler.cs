...
namespace GPUInstancer.CrowdAnimations
{
    ...
    public class NoGameObjectsDemoSceneHandler : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            AnimationClip clip = _crowdPrototype.animationData.clipDataList[_crowdPrototype.animationData.crowdAnimatorDefaultClip].animationClip;
            float clipLength = clip.length;
            for (int i = 0; i < _instanceCount; i++)
            {
                // and start the animation from the corresponding Crowd Animator
                _animators[i].StartAnimation(_runtimeData, i, clip, UnityEngine.Random.Range(0.0f, clipLength));
            }
        ...
        public void RandomizeClips()
        {
            ...
            for (int i = 0; i < _instanceCount; i++)
            {
                ...
                _animators[i].StartAnimation(_runtimeData, i, _crowdPrototype.animationData
                    .clipDataList[UnityEngine.Random.Range(0, _crowdPrototype.animationData.clipDataList.Count)].animationClip);
            }
        }
        ...
        public void RandomizeFrames()
        {
            ...
            for (int i = 0; i < _instanceCount; i++)
            {
                ...
                AnimationClip clip = _animators[i].currentAnimationClipData[0].animationClip;
        ...
        public void ResetAnimations()
        {
            ...
            for (int i = 0; i < _instanceCount; i++)
            {
                ...
                _animators[i].StartAnimation(_runtimeData, i, clip, 0);
            }
        ...
        public void SwitchProtoype()
        {
            ...
            // make sure crowd animator workflow is being used

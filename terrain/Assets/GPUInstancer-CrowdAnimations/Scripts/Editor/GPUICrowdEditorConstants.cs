...
namespace GPUInstancer.CrowdAnimations
{
    ...
    {
        public static readonly string GPUI_CA_VERSION = "GPUI-Crowd Animations v0.9.4";
        public static readonly float GPUI_CA_VERSION_NO = 0.94f;
        ...
        public static readonly string TEXT_bakeAnimationInfo = "Prototype does not have a baked animation data. Please use the Bake Animations button to generate the baked data.";
